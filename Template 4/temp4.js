...
if(summary === ""){
  ...
  for(var i=0;i<skillsarr.length;i++){
    skills.innerHTML+=`<tr style="color:gray;"><td style="color:gray;padding:10px;width: 150px;font-size: 17px">${skillsarr[i].name}</td><td style=" color:#5BB66F;padding:10px;width: 150px;font-size: 17px">${skillsarr[i].level}</td></tr><br>`;
}
